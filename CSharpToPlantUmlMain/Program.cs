...
internal class Program {
	...
	public static ProjectConfiguration CreateConfigFromCode(){
		...
		config.RenderUml = true; // render uml to svg
		var diagram1 = new InheritanceDiagramConfiguration(
				"SomeNamespace.SomeClassOrInterface", // anchor interface from which to process all descendants
		...
		diagram1.FollowBaseTypeMode = EFollowBaseTypeMode.AnchorType;
